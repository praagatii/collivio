...
export const companies: Company[] = [
  ...
  {
    id: "orbit", slug: "orbit", name: "ORBIT LABS", initials: "OL", tone: "#2b2360",
  ...
  {
    id: "mosaic", slug: "mosaic", name: "MOSAIC MAGAZINE", initials: "MM", tone: "#ff8b2e",
  ...
  {
    id: "lumen", slug: "lumen", name: "LUMEN", initials: "LU", tone: "#2ea8e0",
  ...
  {
    id: "aster", slug: "aster", name: "ASTER ROBOTICS", initials: "AR", tone: "#7e5be8",
  ...
  {
    id: "koi", slug: "koi", name: "STUDIO KOI", initials: "SK", tone: "#ff5a4e",
  ...
  {
    id: "signal", slug: "signal", name: "SIGNAL", initials: "SG", tone: "#2ea8e0",
  ...
  {
    id: "greenroom", slug: "greenroom", name: "THE GREEN ROOM", initials: "GR", tone: "#41d17d",
  ...
  {
    id: "foundry", slug: "foundry", name: "FOUNDRY", initials: "FD", tone: "#ff8b2e",
  ...
  {
    id: "halftime", slug: "halftime", name: "HALFTIME SPORTS", initials: "HT", tone: "#7e5be8",
  ...
  {
    id: "atlas", slug: "atlas", name: "ATLAS", initials: "AT", tone: "#2ea8e0",
  ...
  {
    id: "ember", slug: "ember", name: "EMBER", initials: "EB", tone: "#ff5a4e",
